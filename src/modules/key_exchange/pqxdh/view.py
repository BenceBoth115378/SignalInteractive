...
from modules.base_view import make_copy_handler
from modules.key_exchange.key_exchange_base_view import (
...
def build_visual(
    ...
    extra_bob_controls: list[ft.Control] = []
    ...
    phase_controls.append(
        build_message_phase_container(
            ...
            extra_bob_result_controls=extra_bob_controls,
        )
    )
    ...
    return build_key_exchange_layout(header_controls, phase_controls, summary_section, state.get("events", []), tooltips)
